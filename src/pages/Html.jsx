...
const Html = () => {
  const openMateri = (idx) => {
    ...
    materi[idx].style.display =
      !materi[idx].style.display || materi[idx].style.display === 'none'
        ? 'block'
        : 'none';
  };
  ...
  return (
    <div className="card-content">
      <Section title="Struktur Dasar HTML">
        <div>
          <p>
...
`}
      ...
      <Section title="Cara membuat HTML">
        <HighlightSyntax>
          {`<!DOCTYPE html>
<html lang="en">
<head>
...
`}
      ...
      <Section title="Styling pada HTML">
        <p>
