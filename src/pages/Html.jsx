...
`}
        ...
        <Section id="styling-html" title="Styling pada HTML">
          <div className="card-content bg-white b-1">
            <p>
              Kita bisa memberikan style pada element html, caranya adalah
              dengan menggunakan atribut <code>style</code>.
            </p>
            <h3>Contoh 1:</h3>
            <div>
              <HighlightSyntax>
...
akan ada margin/jarak sebesar 20px (pixel), kita bisa menggunakan style text-indent [number]px untuk memberi jarak pada baris paragraf pertama
            ...
            >
              ...
              style text-indent [number]px untuk memberi jarak pada baris
              paragraf pertama
            </p>
            <h3>Contoh 3:</h3>
          ...
          <div className="card-content bg-white b-1 mt-1">
            ...
            <ol>
              ...
              <li id="shape">
                ...
                <p>
                  Secara default element html berbentuk kotak, div dengan
                  bantuan style bisa dibuat menjadi beberapa bentuk, contohnya
                  frame bulat avatar
                </p>
                <div className="flex">
                  <div
